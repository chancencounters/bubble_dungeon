	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function checkCollisions() {
	      ...
	      this.allBubbles().forEach(function (bubble) {
	        if (bubble !== -1) {
	          if (_this2.checkCollision(bubble.bubble, _this2.gun.currentBubble)) {
	            _this2.turns -= 1;
	            _this2.gun.currentBubble.stop();
	    ...
	    value: function checkLost() {
	      ...
	      this.allBubbles().forEach(function (bubble) {
	        if (bubble.y > 405 && bubble.vy === 0) _this5.reset();
	        if (_this5.turns === 0) _this5.renderLoseMsg();
	      });
	    }
	  }, {
	    key: "renderLoseMsg",
