	...
	var Bubble = function () {
	  ...
	  _createClass(Bubble, [{
	    ...
	    value: function getBoardPosition() {
	      var col = Math.round(this.y / Constants.rowHeight);
	      var row = void 0;
	      if (col % 2 === 0) {
	        row = Math.round((this.x - 16) / Constants.rowWidth);
	      } else {
	        row = Math.round(this.x / Constants.rowWidth);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bubble = __webpack_require__(1);
	var Turret = __webpack_require__(5);
	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function checkCollisions() {
	      ...
	      this.allBubbles().forEach(function (bubble) {
	        if (bubble !== -1) {
	          if (_this3.checkCollision(bubble.bubble, _this3.currentBubble) || _this3.currentBubble.y <= 0) {
	            _this3.turns -= 1;
	            _this3.snapBubble();
