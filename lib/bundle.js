	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function renderScore() {
	      ...
	      var text = new createjs.Text("Score: " + this.score, "18px Arial", "#ffffff");
	      text.x = 350;
	      text.y = 470;
	    ...
	    key: "addBubbleRow",
	    value: function addBubbleRow() {
	      var _this5 = this;
	
	      this.allBubbles().forEach(function (bubble) {
	        if (bubble !== -1) {
	          bubble.y += _this5.rowHeight;
	        }
	      });
	    }
	  }, {
	    ...
	    value: function checkGameOver() {
	      ...
	      this.allBubbles().forEach(function (bubble) {
	        if (bubble.y > 405 && bubble.vy === 0) _this6.reset();
	      });
	    }
	  }, {
	    key: "checkTurn",
